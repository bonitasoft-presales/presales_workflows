...
jobs:
  deploy_uib:
    uses: bonitasoft-presales/presales_workflows/.github/workflows/reusable_deploy_uib.yml@v1.27.0
    with:
...
jobs:
  run_datagen:
    needs: [deploy_sca, prerequisites]
    uses: bonitasoft-presales/presales_workflows/.github/workflows/reusable_run_datagen.yml@v1.27.0
    with:
...
jobs:
  status_server:
    uses: bonitasoft-presales/presales_workflows/.github/workflows/reusable_status_server.yml@v1.27.0
    secrets: inherit
----
...
jobs:
  list_server:
    uses: bonitasoft-presales/presales_workflows/.github/workflows/reusable_list_server.yml@v1.27.0
    secrets: inherit
----
...
jobs:
  check_licenses:
    uses: bonitasoft-presales/presales_workflows/.github/workflows/reusable_check_licenses.yml@v1.27.0
    with:
...
jobs:
  setup_tunnel:
    uses: bonitasoft-presales/presales_workflows/.github/workflows/reusable_create_sshTunnel_on_aws.yml@v1.27.0
    with:
      bonita_dns_name: "ec2-xx-xxx-xxx-xxx.eu-west-1.compute.amazonaws.com"
