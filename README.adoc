...
jobs:
  deploy_uib:
    uses: bonitasoft-presales/presales_workflows/.github/workflows/reusable_deploy_uib.yml@v1.18.0
    with:
...
jobs:
  run_datagen:
    needs: [deploy_sca, prerequisites]
    uses: bonitasoft-presales/presales_workflows/.github/workflows/reusable_run_datagen.yml@v1.18.0
    with:
...
jobs:
  status_server:
    uses: bonitasoft-presales/presales_workflows/.github/workflows/reusable_status_server.yml@v1.18.0
    secrets: inherit
----
...
jobs:
  list_server:
    uses: bonitasoft-presales/presales_workflows/.github/workflows/reusable_list_server.yml@v1.18.0
    secrets: inherit
----
