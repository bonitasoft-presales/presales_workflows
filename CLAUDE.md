...
jobs:
  create_server:
    uses: bonitasoft-presales/presales_workflows/.github/workflows/reusable_create_server.yml@v1.24.0
    secrets: inherit

  build_sca:
    needs: create_server
    uses: bonitasoft-presales/presales_workflows/.github/workflows/reusable_build_sca.yml@v1.24.0
    secrets: inherit

  deploy_sca:
    needs: build_sca
    uses: bonitasoft-presales/presales_workflows/.github/workflows/reusable_deploy_sca.yml@v1.24.0
    secrets: inherit
```
...
jobs:
  ...
  get_logs:
    uses: bonitasoft-presales/presales_workflows/.github/workflows/reusable_get_bonita_logs.yml@v1.24.0
    with:
  ...
  deploy_uib:
    uses: bonitasoft-presales/presales_workflows/.github/workflows/reusable_deploy_uib_aws.yml@v1.24.0
    with:
      bonita_dns_name: "ec2-xx-xxx-xxx-xxx.eu-west-1.compute.amazonaws.com"
...
jobs:
  handle_pr:
    uses: bonitasoft-presales/presales_workflows/.github/workflows/reusable_pr_closed.yml@v1.24.0
    with:
...
jobs:
  prerequisites:
    uses: bonitasoft-presales/presales_workflows/.github/workflows/reusable_prerequisites.yml@v1.24.0
  ...
  run_tests:
    needs: deploy_sca
    uses: bonitasoft-presales/presales_workflows/.github/workflows/reusable_run_it.yml@v1.24.0
    secrets: inherit
```
